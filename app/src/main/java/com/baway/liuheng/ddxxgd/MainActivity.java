package com.baway.liuheng.ddxxgd;
...
import com.baway.liuheng.ddxxgd.utils.DownloadUtil;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String localPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/local2";
